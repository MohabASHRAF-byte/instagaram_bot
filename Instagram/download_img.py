...
def download_allposts():
    ...
    if multiple_images:
        ...
        save_multiple(user_name + '/' + 'content1.' +
                      str(count_img), elem_img, last_img_flag=True)
    else:
